...
@str = unnamed_addr constant [5 x i8] c"data\00", align 8
@str.1 = unnamed_addr constant [5 x i8] c"test\00", align 8
...
define i64 @Foo_get_x(i64 %self, i64 %0, i64 %1) {
entry:
  %self1 = alloca i64, align 8
  store i64 %self, ptr %self1, align 4
  ret i64 or (i64 lshr (i64 ptrtoint (ptr @str.1 to i64), i64 3), i64 -2111062325329920)
}
...
entry:
  ...
  store i64 %box_ptr_qnan, ptr %f, align 4
  %f1 = load i64, ptr %f, align 4
  %mcall = call i64 @Foo_get_x(i64 %f1)
  %result = alloca i64, align 8
  store i64 %mcall, ptr %result, align 4
  %result2 = load i64, ptr %result, align 4
  call void @kore_println_str(i64 %result2)
  ret i64 0
}
